...
if (isset($_SESSION['message'])) {
    ...
    unset($_SESSION['message']); // ลบข้อความออกจากเซสชันหลังจากแสดงแล้ว
}
?>
<!doctype html>
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <!-- Custom styles for this template -->
    <link href="../type/dashboard.css" rel="stylesheet">
...
<div class="table-responsive">
    <table id="ordersTable" class="table table-bordered table-striped table-hover">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td><?= htmlspecialchars($data['pt_id']); ?></td>
                <td><?= htmlspecialchars($data['pt_name']); ?></td>
                <td>
                    <a href="updatetype.php?id=<?= $data['pt_id']; ?>" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil-square"></i> Edit
                    </a>
                    <a href="deletetype.php?id=<?= $data['pt_id']; ?>" class="btn btn-danger btn-sm" 
            ...
            <td>  <a href="inserttype.php" class="btn btn-success btn-sm">
                    <i class="bi bi-pencil-square"></i> insert
                </a>
