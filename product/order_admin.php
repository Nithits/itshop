...
$sql_orders = "SELECT o.oid, o.ototal, o.odate, o.status_id FROM orders o";
...
<main class="col-md-9 col-lg-10">
    <section class="py-3 text-center container">
        <div class="row py-lg-2">
            <h2 class="h5 text-center mb-4">รายการสั่งซื้อ</h2>
            ...
            <?php else: ?>
                <table id="ordersTable" class="table table-bordered table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        // แก้ไข: โค้ด SQL ที่ดึงข้อมูลทั้งหมดจาก orders โดยไม่กรอง
                        $sql = "SELECT orders.oid, orders.odate, orders.ototal, orders.status_id, users.first_name 
                                FROM orders 
                        ...
                        while ($order = mysqli_fetch_assoc($rs)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="order_detail_admin.php?oid=<?= $order['oid']; ?>" class="btn btn-warning">ดูรายละเอียด</a>
