...
<main class="col-md-9 col-lg-10">
    <section class="py-3 text-center container">
        <div class="row py-lg-2">
            <h1 class="h5 text-center mb-4">เพิ่มสินค้า</h1> <!-- จัดกลาง -->

<div class="form-container"> <!-- กรอบฟอร์ม -->
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="mb-3 text-start">
            ...
            <textarea name="pdetail" id="pdetail" rows="2" class="form-control"></textarea>
        </div>
        ...
        <div class="mb-3 text-center">
            <button type="submit" name="Submit" class="btn btn-success" style="padding: 6px 15px;">
                <i class="bi bi-upload"></i> เพิ่มสินค้า 
            </button>
            <a class="btn btn-secondary" href="indexproductadmin.php" style="padding: 6px 15px; font-size: 0.9rem;">
